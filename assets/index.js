...
class CartList extends HTMLElement {
  connectedCallback() {
    let items = _services_common_cartService__WEBPACK_IMPORTED_MODULE_0__["default"].getItems();
    console.log(items);
  }
...
class ProductForm extends HTMLElement {
  constructor() {
    ...
    _ProductForm_handleSubmit.set(this, event => {
      ...
      _services_common_cartService__WEBPACK_IMPORTED_MODULE_0__["default"].addProduct(cartItem);
...
class CartService {
  constructor() {
    ...
    this.getItems = () => {
      let data;
      fetch(__classPrivateFieldGet(this, _CartService_endpoint, "f") + "/cart.js", {
        method: "GET",
        headers: {
          'Content-Type': 'application/json'
        }
