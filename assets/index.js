...
var _CartList_data, _CartList_cart, _CartList_clearButton, _CartList_totalPrice, _CartList_button, _CartList_updateCartDisplay, _CartList_displayTotalPrice, _CartList_handleClick, _CartList_createProductTemplate;
...
class CartList extends HTMLElement {
  constructor() {
    ...
    _CartList_cart.set(this, void 0);
    ...
    _CartList_updateCartDisplay.set(this, () => {});

    _CartList_displayTotalPrice.set(this, () => __awaiter(this, void 0, void 0, function* () {
      const total = (yield _services_common_cartService__WEBPACK_IMPORTED_MODULE_0__["default"].getTotalPrice()) / 100;
      __classPrivateFieldGet(this, _CartList_totalPrice, "f").innerText = `£ ${total}`;
      console.log(total);
    }));

    _CartList_handleClick.set(this, () => {
      console.log("list", __classPrivateFieldGet(this, _CartList_cart, "f"));
    });
  ...
  connectedCallback() {
    ...
    __classPrivateFieldSet(this, _CartList_cart, _services_common_cartService__WEBPACK_IMPORTED_MODULE_0__["default"].getCart(), "f");

    console.log(__classPrivateFieldGet(this, _CartList_cart, "f"));
...
_CartList_data = new WeakMap(), _CartList_cart = new WeakMap(), _CartList_clearButton = new WeakMap(), _CartList_totalPrice = new WeakMap(), _CartList_button = new WeakMap(), _CartList_updateCartDisplay = new WeakMap(), _CartList_displayTotalPrice = new WeakMap(), _CartList_handleClick = new WeakMap(), _CartList_createProductTemplate = new WeakMap();
...
class ProductForm extends HTMLElement {
  constructor() {
    ...
    _ProductForm_testButton.set(this, void 0);
    ...
    _ProductForm_product.set(this, void 0);

    _ProductForm_variantId.set(this, void 0);

    _ProductForm_variantStock.set(this, 6);

    _ProductForm_variantOptions.set(this, void 0);

    _ProductForm_decrementQuantityButton.set(this, void 0);

    _ProductForm_incrementQuantityButton.set(this, void 0);

    _ProductForm_quantityInput.set(this, void 0);

    _ProductForm_runTest.set(this, () => {
      console.log(__classPrivateFieldGet(this, _ProductForm_productObject, "f"));
    });
    ...
    _ProductForm_handleSubmit.set(this, event => {
      ...
      const cartItem = {
        ...
        quantity: parseInt(__classPrivateFieldGet(this, _ProductForm_quantityInput, "f").value)
      };
    ...
    _ProductForm_initProductQuantity.set(this, () => {
      __classPrivateFieldSet(this, _ProductForm_decrementQuantityButton, this.querySelector("[data-decrement-quantity]"), "f");

      __classPrivateFieldSet(this, _ProductForm_incrementQuantityButton, this.querySelector("[data-increment-quantity]"), "f");

      __classPrivateFieldSet(this, _ProductForm_quantityInput, this.querySelector("#product-quantity"), "f");

      __classPrivateFieldGet(this, _ProductForm_decrementQuantityButton, "f").addEventListener("click", __classPrivateFieldGet(this, _ProductForm_decrementQuantity, "f"));

      __classPrivateFieldGet(this, _ProductForm_incrementQuantityButton, "f").addEventListener("click", __classPrivateFieldGet(this, _ProductForm_incrementQuantity, "f"));
    });

    _ProductForm_destroyProductQuantity.set(this, () => {
      __classPrivateFieldGet(this, _ProductForm_decrementQuantityButton, "f").removeEventListener("click", __classPrivateFieldGet(this, _ProductForm_decrementQuantity, "f"));

      __classPrivateFieldGet(this, _ProductForm_incrementQuantityButton, "f").removeEventListener("click", __classPrivateFieldGet(this, _ProductForm_incrementQuantity, "f"));
    });

    _ProductForm_incrementQuantity.set(this, e => {
      e.preventDefault();

      if (parseInt(__classPrivateFieldGet(this, _ProductForm_quantityInput, "f").value) >= __classPrivateFieldGet(this, _ProductForm_variantStock, "f")) {
        return;
      }

      __classPrivateFieldGet(this, _ProductForm_quantityInput, "f").value = `${parseInt(__classPrivateFieldGet(this, _ProductForm_quantityInput, "f").value) + 1}`;
    });

    _ProductForm_decrementQuantity.set(this, e => {
      e.preventDefault();

      if (parseInt(__classPrivateFieldGet(this, _ProductForm_quantityInput, "f").value) <= 1) {
        return;
      }
  ...
  connectedCallback() {
    __classPrivateFieldSet(this, _ProductForm_testButton, this.querySelector("[data-test-button]"), "f");

    __classPrivateFieldGet(this, _ProductForm_testButton, "f").addEventListener("click", __classPrivateFieldGet(this, _ProductForm_runTest, "f"));
  ...
  disconnectedCallback() {
    __classPrivateFieldGet(this, _ProductForm_destroyProductQuantity, "f").call(this);
  }
...
var _CartService_locale;

class CartService {
  constructor() {
    this.shopUrl = "https://escalator-poc.myshopify.com";
    ...
    this.removeProducts = ids => __awaiter(this, void 0, void 0, function* () {
      ...
      yield fetch(this.shopUrl + "/cart/update.js", {
        method: "POST",
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    this.getCart = () => __awaiter(this, void 0, void 0, function* () {
      return yield fetch(this.shopUrl + "/cart.js", {
        method: "GET",
        headers: {
          'Content-Type': 'application/json'
        }
    ...
    this.getItems = () => __awaiter(this, void 0, void 0, function* () {
      const cart = yield fetch(this.shopUrl + "/cart.js", {
        method: "GET",
        headers: {
          'Content-Type': 'application/json'
        }
...
_CartService_locale = new WeakMap();
