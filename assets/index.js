...
var _CartList_data, _CartList_clearButton, _CartList_button, _CartList_handleClick, _CartList_clearCart;
...
class CartList extends HTMLElement {
  constructor() {
    ...
    _CartList_clearCart.set(this, () => {
      _services_common_cartService__WEBPACK_IMPORTED_MODULE_0__["default"].clearItems();
    });
  }
  ...
  connectedCallback() {
    ...
    __classPrivateFieldGet(this, _CartList_clearButton, "f").addEventListener("click", __classPrivateFieldGet(this, _CartList_clearCart, "f"));
  }
  ...
  disconnectedCallback() {
    ...
    __classPrivateFieldGet(this, _CartList_clearButton, "f").removeEventListener("click", __classPrivateFieldGet(this, _CartList_clearCart, "f"));
  }

}
_CartList_data = new WeakMap(), _CartList_clearButton = new WeakMap(), _CartList_button = new WeakMap(), _CartList_handleClick = new WeakMap(), _CartList_clearCart = new WeakMap();
